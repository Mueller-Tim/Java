...
public class Spiel 
{
    ...
    private void raeumeAnlegen()
    {
        ...
        draussen.setAusgaenge("osten", hoersaal);
        draussen.setAusgaenge("sueden", labor);
        draussen.setAusgaenge("westen", cafeteria);
        hoersaal.setAusgaenge("westen", draussen);
        cafeteria.setAusgaenge("osten", draussen);
        labor.setAusgaenge("norden", draussen);
        labor.setAusgaenge("osten", buero);
        buero.setAusgaenge("westen", labor);
