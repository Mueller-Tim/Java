public class FensterBriefdruckStrategie implements BriefdruckStrategie{
	...
	public void druckeBrief(Brief brief){
		...
		System.out.println();
		System.out.println(String.format("%40s", brief.getEmpfaenger().getVorname() + " "  + brief.getEmpfaenger().getNachname()));
		System.out.println(String.format("%40s",brief.getEmpfaenger().getStrasse() + " " + brief.getEmpfaenger().getHausnummer()));
		System.out.println(String.format("%40s",brief.getEmpfaenger().getPlz() + " " + brief.getEmpfaenger().getOrt()));
		System.out.println();
