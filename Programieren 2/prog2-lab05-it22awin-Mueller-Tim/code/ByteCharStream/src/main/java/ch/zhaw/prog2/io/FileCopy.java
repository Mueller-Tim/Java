...
public class FileCopy {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.print("Source Directory verified successfully.");
...
//        System.out.println("Files copied successfully.");
    ...
    private static void verifySourceDir(File sourceDir) throws FileNotFoundException, InvalidObjectException {
        if(sourceDir.exists() && sourceDir.isDirectory() && sourceDir.listFiles().length >= 2){
            for(File file : sourceDir.listFiles()){
                if(!file.getAbsolutePath().equals("./files/rmz450.jpg") && !file.getAbsolutePath().equals("./files/rmz450-spec.txt")){
                    throw new InvalidObjectException("Source directory contains invalid files or directories");
                }
            }
        } else {
